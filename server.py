...
def tools_index():
    ...
    tools = [
        ...
        {"url": "/tools/uap-document-finder", "name": "Find Original UFO Documents", "category": "Source library", "count": stats["documents"], "summary": "Find the actual government archive pages, official reports, study material, source documents, and public records behind the topic."},
        {"url": "/tools/uap-government-program-search", "name": "Search Government UFO Programs", "category": "Government programs", "count": program_stats()["total"], "summary": "Look up known and rumored government UFO programs, then see which ones are confirmed, disputed, proposed, alleged, or denied."},
        {"url": "/tools/uap-evidence-grader", "name": "See Which UFO Cases Have the Best Records", "category": "Record strength", "count": stats["cases"], "summary": "Compare incidents by how much public material exists: official documents, videos, sensor details, explanations, and links to original sources."},
    ]
